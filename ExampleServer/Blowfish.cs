...
namespace ExampleServer
{
    public class BlowFish
    {
        ...
        /// <summary>
        /// Encrypts a uint64 (ECB)
        /// </summary>
        /// <param name="ct">ulong/param>
        /// <returns>ulong</returns>
        public ulong Encrypt(ulong ct)
        {
        ...
        /// <summary>
        /// Decrypts a uint64 (ECB)
        /// </summary>
        /// <param name="ct">ulong</param>
        /// <returns>ulong</returns>
        public ulong Decrypt(ulong ct)
        {
            byte[] source = new byte[]
            {
                (byte)(ct >> 0),
