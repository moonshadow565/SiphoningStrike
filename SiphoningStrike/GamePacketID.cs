...
namespace SiphoningStrike
{
    ...
    */
    public enum GamePacketID
    {
        ...
        Turret_CreateTurret                      = 0x040, // Todo: unused?
        MissileReplication                       = 0x041, // Done
        ...
        MissileReplication_ChainMissile          = 0x071, // Todo: unused?
        ...
        NPC_BuffRemoveGroup                      = 0x09B, // Done
        Turret_Fire                              = 0x09C, // Todo: unused?
        ...
        OnReplication_Acc                        = 0x0B0, // Done
        OnDisconnected                           = 0x0B1, // Todo: unused?
        S2C_SetGreyscaleEnabledWhenDead          = 0x0B2, // Done
        S2C_AI_State                             = 0x0B3, // Done
        S2C_SetFoWStatus                         = 0x0B4, // Done
        OnEnterLocalVisiblityClient              = 0x0B7, // Done
        S2C_HighlightShopElement                 = 0x0B8, // Done
        SendSelectedObjID                        = 0x0B9, // Done
        S2C_PlayAnimation                        = 0x0BA, // Done
        S2C_RefreshAuxiliaryText                 = 0x0BB, // Done
        SetFadeOut_Push                          = 0x0BC, // Done
        S2C_OpenTutorialPopup                    = 0x0BD, // Done
        S2C_RemoveUnitHighlight                  = 0x0BE, // Done
        NPC_CastSpellAns                         = 0x0BF, // Done
        Unused_SPM_HierarchicalBBProfileUpdate   = 0x0C0, // Done
        NPC_BuffAdd2                             = 0x0C1, // Done
        S2C_OpenAFKWarningMessage                = 0x0C2, // Done
        WaypointList                             = 0x0C3, // Done
        OnEnterVisiblityClient                   = 0x0C4, // Done
        S2C_AddDebugCircle                       = 0x0C5, // Done
        S2C_DisableHUDForEndOfGame               = 0x0C6, // Done
        SynchVersionC2S                          = 0x0C7, // Done
        C2S_CharSelected                         = 0x0C8, // Done
        NPC_BuffUpdateCountGroup                 = 0x0C9, // Done
        AI_TargetHeroS2C                         = 0x0CA, // Done
        SynchSimTimeS2C                          = 0x0CB, // Done
        SyncMissionStartTimeS2C                  = 0x0CC, // Done
        S2C_Neutral_Camp_Empty                   = 0x0CD, // Done
        OnReplication                            = 0x0CE, // Done
        S2C_EndOfGameEvent                       = 0x0CF, // Done
        S2C_EndGame                              = 0x0D0, // Done
        Unused_Undefined                         = 0x0D1, // Done
        Unused_SPM_SamplingProfilerUpdate        = 0x0D2, // Done
        S2C_PopAllCharacterData                  = 0x0D3, // Done
        S2C_TeamSurrenderVote                    = 0x0D4, // Done
        S2C_HandleUIHighlight                    = 0x0D5, // Done
        S2C_FadeMinions                          = 0x0D6, // Done
        C2S_OnTutorialPopupClosed                = 0x0D7, // Done
        C2S_OnQuestEvent                         = 0x0D8, // Done
        S2C_ShowHealthBar                        = 0x0D9, // Done
        SpawnBotS2C                              = 0x0DA, // Done
        SpawnLevelPropS2C                        = 0x0DB, // Done
        UpdateLevelPropS2C                       = 0x0DC, // Done
        AttachFlexParticleS2C                    = 0x0DD, // Done
        S2C_HandleCapturePointUpdate             = 0x0DE, // Done
        S2C_HandleGameScore                      = 0x0DF, // Done
        S2C_HandleRespawnPointUpdate             = 0x0E0, // Done
        C2S_OnRespawnPointEvent                  = 0x0E1, // Done
        S2C_UnitChangeTeam                       = 0x0E2, // Done
        S2C_UnitSetMinimapIcon                   = 0x0E3, // Done
        S2C_IncrementPlayerScore                 = 0x0E4, // Done
        S2C_IncrementPlayerStat                  = 0x0E5, // Done
        S2C_ColorRemapFX                         = 0x0E6, // Done
        S2C_MusicCueCommand                      = 0x0E7, // Done
        Unused_S2C_AntiBot                       = 0x0E8, // Done
        Unused_S2C_AntiBotWriteLog               = 0x0E9, // Done
        Unused_S2C_AntiBotKickOut                = 0x0EA, // Done
        Unused_S2C_AntiBotBanPlayer              = 0x0EB, // Done
        Unused_S2C_AntiBotTrojan                 = 0x0EC, // Done
        Unused_S2C_AntiBotCloseClient            = 0x0ED, // Done
        Unused_C2S_AntiBotDP                     = 0x0EE, // Done
        Unused_ED                                = 0x0EF, // Done
        S2C_OnEnterTeamVisiblity                 = 0x0F0, // Done
        S2C_OnLeaveTeamVisiblity                 = 0x0F1, // Done
        S2C_FX_OnEnterTeamVisiblity              = 0x0F2, // Done
        S2C_FX_OnLeaveTeamVisiblity              = 0x0F3, // Done
        ReplayOnly_GoldEarned                    = 0x0F4, // Done
